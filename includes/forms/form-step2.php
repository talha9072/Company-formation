...
<div class="step-form-wrapper step2-wrapper">
    ...
    <div style="background:#f5f7fb;border-radius:8px;padding:25px;margin-bottom:35px;">
        <h2 style="font-size:28px;color:#4a3b8f;margin-bottom:10px;">
            Addresses
        </h2>

        <p style="color:#555;line-height:1.6;margin:0 0 12px;">
            <strong>Registered Office</strong><br>
            The official address of an incorporated company. This must be located within the country of registration.
        </p>

        <p style="color:#555;line-height:1.6;margin:0;">
            <strong>Registered Email</strong><br>
            Used for official company correspondence (not publicly visible).
        </p>
    </div>
    ...
    <form id="step2form">
        ...
        <div id="own-address-form"
            ...
            <div style="display:flex;gap:10px;margin-bottom:20px;">
                <input type="text" id="postcode_search" placeholder="Enter postal code"
                       style="flex:1;padding:12px;border:1px solid #ccc;border-radius:6px;">
                
                <button type="button" id="find-address"
                        style="background:#1a8f4a;color:white;border:none;
            ...
            <input type="text" id="addr_line3" name="addr_line3"
                   placeholder="Address Line 3"
                   style="width:100%;padding:12px;border:1px solid #ccc;border-radius:6px;margin-bottom:15px;">

            <label>Town *</label>
            <input type="text" id="addr_line4" name="addr_line4"
                   placeholder="Town"
                   style="width:100%;padding:12px;border:1px solid #ccc;border-radius:6px;margin-bottom:15px;">
            ...
            <div style="display:flex;gap:15px;">
                ...
                <div style="flex:1;">
                    ...
                    <input type="text" id="addr_postcode" name="addr_postcode"
